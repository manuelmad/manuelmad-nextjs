            ...
            <nav className={styles.header_nav}>
                <div className={styles.container__menu_principal}>
                    <ul id="menu-principal" className={styles.menu_principal}>
                        <li className={styles.menu_principal_li}>
                            <Link className={styles.menu_principal_a} href="/projects">PROJECTS</Link>
                            </li>
                        <li className={styles.menu_principal_li}>
                            <Link className={styles.menu_principal_a} href="/">ABOUT ME</Link>
                            </li>
                        <li className={styles.menu_principal_li}>
                            <Link className={styles.menu_principal_a} href="/">STUDIES</Link>
                            </li>
                        <li className={styles.menu_principal_li}>
                            <Link className={styles.menu_principal_a} href="/">CONTACT</Link>
                        </li>
                    </ul>
                </div>
                <div className={styles.container__icono_menu}>
                    ...
                    <ul id="menu-desplegable" className={styles.menu_desplegable}>
                        ...
                        <li className={styles.menu_desplegable_li}>
                            <Link className={styles.menu_desplegable_a}  href="/">
